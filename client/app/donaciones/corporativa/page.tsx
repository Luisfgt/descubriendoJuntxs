...
const DonacionesCorporativasPage: React.FC = () => {
  ...
  return (
    <div className="w-screen h-[80vh]  flex justify-center items-center">
      ...
      <div className="w-11/12 h-11/12 border border-blue-400 py-2 mt-8 rounded-2xl shadow-2xl flex justify-center md:h-4/5 md:mt-2">
          ...
          >
            <div className=" w-5/6 h-full  flex flex-col justify-center">
              <div className="w-full flex justify-center ">
                <div className=" w-11/12  flex flex-col items-center md:4/5">
